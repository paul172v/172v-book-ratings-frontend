...
import classes from "./HighestRatedSection.module.css";
...
const HighestRatedSection = () => {
  ...
  useEffect(() => {
    fetch("https://book-ratings-172v.herokuapp.com/books/v1/highest-rated")
...
export default HighestRatedSection;
